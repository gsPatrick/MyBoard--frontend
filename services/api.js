...
export const ENDPOINTS = {
  ...
  auth: {
    ...
    passkeyLoginOptions: `/${API_VERSION}/auth/passkey/login/options`,
    passkeyLoginVerify: `/${API_VERSION}/auth/passkey/login/verify`,
    passkeyRegisterOptions: `/${API_VERSION}/auth/passkey/register/options`,
    passkeyRegisterVerify: `/${API_VERSION}/auth/passkey/register/verify`,
    passkeyList: `/${API_VERSION}/auth/passkey`,
    passkeyDelete: (id) => `/${API_VERSION}/auth/passkey/${id}`,
    ...
    sessionRevoke: (id) => `/${API_VERSION}/auth/sessions/${id}`,
    sessionsRevokeOthers: `/${API_VERSION}/auth/sessions/others`,
  },
